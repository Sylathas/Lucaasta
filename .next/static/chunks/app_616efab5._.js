...
(()=>{
    const e = new Error("Cannot find module '@/app/hooks/useAboutData'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
function AdminPage() {
    ...
    const { aboutData, loadAboutData, saveAboutData } = useAboutData();
...
//# sourceMappingURL=app_616efab5._.js.map